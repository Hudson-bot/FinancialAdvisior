...
const BudgetAI = ({ onClose }) => {
  // const apiKey = process.env.REACT_APP_OPENROUTER_API_KEY;
  const apiKey = import.meta.env.VITE_OPENROUTER_API_KEY;

  const [messages, setMessages] = useState([
    {
      text: "Hi! I'm your Budget Assistant. Ask me anything about saving money, budgeting, or financial planning.",
      sender: 'ai',
    }
  ]);
      ...
      >
        <div className="bg-[#4B1F52] text-white p-4 rounded-t-xl flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-bold">Budget AI Assistant</h3>
          </div>
